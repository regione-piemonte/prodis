...
@Directive({
  selector: '[prodisDisabledTt]'
})
export class ProdisDisabledTooltipDirective extends NgbTooltip implements OnInit {

  @Input() prodisDisabledTt: string;
  ...
  @HostListener('mouseenter') onMouseEnter() {
    const text = this.prodisDisabledTt;
