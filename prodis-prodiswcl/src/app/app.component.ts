...
import { UtenteService, Utente } from 'src/app/modules/prodisapi';
import { Router, NavigationEnd } from '@angular/router';
import { filter } from 'rxjs/operators';
import { POSSIBLE_SIDEBAR_MODULES } from 'src/app/models';
import { marker } from '@biesbjerg/ngx-translate-extract-marker';
import { ApiError } from 'src/app/modules/prodisapi';

@Component({
  selector: 'prodis-root',
...
export class AppComponent implements OnInit, OnDestroy, AfterViewInit, AfterContentInit {
  ...
  @ViewChild('prodisSidebar', { static: false }) prodisSidebar: Sidebar;
  ...
  ngAfterViewInit() {
    ...
    //     this.prodisSidebar.triggerRerender();
    //   }),
    // );
