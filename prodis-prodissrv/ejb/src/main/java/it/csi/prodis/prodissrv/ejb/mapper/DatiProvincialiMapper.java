...
@Mapper(uses = { ProspettoProvSedeMapper.class, ProvConvenzioneMapper.class, ProvEsoneroAutocertMapper.class,
		ProvSospensioneMapper.class, ProvGradualitaMapper.class })
public interface DatiProvincialiMapper extends BaseMapperInterface<DatiProvinciali, ProDDatiProvinciali> {
	...
	//@Mapping(source = "proDPostiLavoroDisps", target = "postiLavoroDisps")
	//@Mapping(source = "proDLavoratoriInForzas", target = "lavoratoriInForzas")
	//@Mapping(source = "proDProvCompensazionis", target = "provCompensazionis")
