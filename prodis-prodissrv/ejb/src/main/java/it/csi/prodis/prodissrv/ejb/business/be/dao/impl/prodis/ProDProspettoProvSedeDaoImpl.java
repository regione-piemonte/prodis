...
/**
 * Data Access Object implementor for the entity ProDProspettoProvSede
 */
@ApplicationScoped
public class ProDProspettoProvSedeDaoImpl extends BaseEntityDaoImpl<Long, ProDProspettoProvSede> implements ProDProspettoProvSedeDao {

	@Override
	public List<ProDProspettoProvSede> findByField(String field) {
		Map<String, Object> params = new HashMap<String, Object>();
		StringBuilder jpql = new StringBuilder();
		jpql.append(" FROM ProDProspettoProvSede t ");
		...
		TypedQuery<ProDProspettoProvSede> query = composeTypedQuery(jpql, params);
