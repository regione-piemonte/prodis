...
public class ProDAssPubbliche implements Serializable, BaseEntity<ProDAssPubblichePK> {
...
//	Caused by: org.hibernate.MappingException: Repeated column in mapping for entity: it.csi.prodis.prodissrv.ejb.entity.ProDAssPubbliche column: ID_PROSPETTO (should be mapped with insert="false" update="false")
	@ManyToOne
