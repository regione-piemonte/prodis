...
public final class ProdisMappers {
	...
	public static final ProspettoGradualitaMapper PROSPETTO_GRADUALITA = Mappers
			.getMapper(ProspettoGradualitaMapper.class);
	...
	public static final ProvEsoneroAutocertMapper PROV_ESONERO_AUTOCERT = Mappers
			.getMapper(ProvEsoneroAutocertMapper.class);
	...
	public static final RiepilogoNazionaleMapper RIEPILOGO_NAZIONALE = Mappers
			.getMapper(RiepilogoNazionaleMapper.class);
	public static final RiepilogoProvincialeMapper RIEPILOGO_PROVINCIALE = Mappers
			.getMapper(RiepilogoProvincialeMapper.class);
	...
	public static final ProspettoProvinciaMapper PROSPETTO_PROVINCIA = Mappers
			.getMapper(ProspettoProvinciaMapper.class);
	public static final AssunzioneProtettaMapper ASSUNZIONE_PROTETTA = Mappers
			.getMapper(AssunzioneProtettaMapper.class);
	...
	public static final ImportErroriSpicomMapper IMPORT_ERRORI_SPICOM = Mappers
			.getMapper(ImportErroriSpicomMapper.class);
