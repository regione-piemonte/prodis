...
import it.csi.prodis.prodissrv.ejb.business.be.service.impl.base.BaseService;
 ...
 */
public abstract class BaseProspettoService<Q extends BaseRequest, R extends BaseResponse> extends BaseService<Q, R> {
	 ...
	 */
	protected BaseProspettoService(ConfigurationHelper configurationHelper, ProspettoDad prospettoDad) {
