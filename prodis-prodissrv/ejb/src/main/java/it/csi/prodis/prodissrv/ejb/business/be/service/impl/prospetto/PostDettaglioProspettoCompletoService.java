 ...
 */
public class PostDettaglioProspettoCompletoService
		extends BaseProspettoService<PostDettaglioProspettoCompletoRequest, PostDettaglioProspettoCompletoResponse> {
	 ...
	 */
	public PostDettaglioProspettoCompletoService(ConfigurationHelper configurationHelper, ProspettoDad prospettoDad) {
	...
	protected void execute() {
		...
		try {
			...
			Prospetto prospetto = prospettoDad.getDatiNazionali(request.getFilterServiziProdis().getIdProspetto());
