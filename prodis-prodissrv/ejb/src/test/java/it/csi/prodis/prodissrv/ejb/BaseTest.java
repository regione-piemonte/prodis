 ...
 * =========================LICENSE_END==================================
 */
package it.csi.prodis.prodissrv.ejb;
...
public abstract class BaseTest {
	...
	public static EnterpriseArchive createDeployment() {
		...
		JavaArchive ejb = ShrinkWrap.create(JavaArchive.class, "prodissrv-ejb-test.jar")
				.addPackages(true, "it.csi.prodis.prodissrv.ejb")
