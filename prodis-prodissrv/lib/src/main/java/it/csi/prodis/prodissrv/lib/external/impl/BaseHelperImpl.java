 ...
 * =========================LICENSE_END==================================
 */
package it.csi.prodis.prodissrv.lib.external.impl;
...
import it.csi.prodis.prodissrv.lib.external.itf.BaseHelper;
...
import it.csi.prodis.prodissrv.lib.util.pagination.PagedListImpl;
import it.csi.prodis.prodissrv.lib.util.soap.DefaultHandlerResolver;
...
public abstract class BaseHelperImpl implements BaseHelper {
	...
	/**
	 * Transforms the paged list SIAC-like to paged list PRODIS-like
	 * @param <A> the SIAC type
	 * @param <B> the PRODIS type
	 * @param list the list
