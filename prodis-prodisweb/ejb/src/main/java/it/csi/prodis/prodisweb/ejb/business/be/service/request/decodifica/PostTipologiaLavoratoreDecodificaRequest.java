 ...
 */
public class PostTipologiaLavoratoreDecodificaRequest implements BaseRequest {

	
	private final DecodificaGenerica filtro;
	
	public PostTipologiaLavoratoreDecodificaRequest(DecodificaGenerica filtro) {
		this.filtro = filtro;
	}
	...
	public String toString() {
		...
		builder.append("PostTipologiaLavoratoreDecodificaRequest []");
