 ...
 */
public class GetPartTimeByIdProspettoProvService
		extends BaseDatiProvincialiService<GetPartTimeByIdProspettoProvRequest, GetPartTimeByIdProspettoProvResponse> {
	 ...
	 */
	public GetPartTimeByIdProspettoProvService(ConfigurationHelper configurationHelper,
	...
	protected void execute() {
		List<PartTime> list = datiProvincialiDad.getPartTimeByIdProspettoProv(request.getIdProspettoProv());
		response.setPartTimes(list);
	}
