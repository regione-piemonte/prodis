...
public class DeleteIntermittentiResponse extends BasePostResponse<Integer, ProvIntermittenti> {
	...
	public String toString() {
		...
		builder.append("DeleteIntermittentiResponse [intermittenti=").append(intermittenti).append(", apiErrors=")
