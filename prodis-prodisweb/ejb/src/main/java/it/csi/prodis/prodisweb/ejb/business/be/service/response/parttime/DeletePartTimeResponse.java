...
public class DeletePartTimeResponse extends BasePostResponse<Integer, PartTime> {
	...
	public String toString() {
		...
		builder.append("DeletePartTimeResponse [partTime=").append(partTime).append(", apiErrors=")
