 ...
 */
public class PostProspettoResponse extends BasePostResponse<Long, Prospetto> {
	...
	public String toString() {
		...
		builder.append("PostProspettoResponse [prospetto=").append(prospetto).append(", apiErrors=")
