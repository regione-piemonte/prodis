...
public class DeleteCompensazioniResponse extends BasePostResponse<Integer, ProvCompensazioni> {
	...
	public String toString() {
		...
		builder.append("DeleteCompensazioniResponse [compensazioni=").append(compensazioni).append(", apiErrors=")
