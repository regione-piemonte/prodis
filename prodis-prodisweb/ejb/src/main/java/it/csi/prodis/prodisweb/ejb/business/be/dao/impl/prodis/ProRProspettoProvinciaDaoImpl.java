 ...
 */
@ApplicationScoped
public class ProRProspettoProvinciaDaoImpl extends BaseAuditedEntityDaoImpl<Long, ProRProspettoProvincia>
	...
	public List<ProRProspettoProvincia> findByIdProspetto(Long idProspetto) {
		...
		BigDecimal idProspettoBig = new BigDecimal(idProspetto);
		...
		JpaQueryHelper.andFieldEquals(jpql, params, "t.idProspetto", "field", idProspettoBig);

		jpql.append(" ORDER BY t.proTProvincia.dsProTProvincia ");
