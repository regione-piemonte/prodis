...
public class PostLavoratoriInForzaService extends BaseLavoratoriInForzaService<PostLavoratoriInForzaRequest, PostLavoratoriInForzaResponse> {
	/**
	 * Constructor
	 * 
	 ...
	 */
	public PostLavoratoriInForzaService(ConfigurationHelper configurationHelper, LavoratoriInForzaDad lavoratoriInForzaDad) {
	...
	protected void execute() {
		...
		if (apiErrors == null || apiErrors.size() == 0) {
			...
			if (lavoratoriInForza.getId()==null) {
				lavoratoriInForza = lavoratoriInForzaDad.insertSingleLavoratoriInForza(
						lavoratoriInForza, lavoratoriInForza.getIdProspettoProv().intValue(), "S");
			} else {
