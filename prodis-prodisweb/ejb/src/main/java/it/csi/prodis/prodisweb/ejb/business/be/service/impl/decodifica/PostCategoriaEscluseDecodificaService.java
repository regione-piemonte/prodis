 ...
 */
public class PostCategoriaEscluseDecodificaService extends BaseDecodificaService<PostCategoriaEscluseDecodificaRequest, PostDecodificaGenericaResponse> {
	 ...
	 */
	public PostCategoriaEscluseDecodificaService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
	...
	protected void execute() {
		...
		response.setDecodificaGenericas( decodificaDad.getCategoriaEscluseDecodifica(request.getFiltro() ));
	}
