 ...
 */
public class PostDichiaranteDecodificaService extends BaseDecodificaService<PostDichiaranteDecodificaRequest, PostDecodificaGenericaResponse> {
	 ...
	 */
	public PostDichiaranteDecodificaService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
	...
	protected void execute() {
		...
		response.setDecodificaGenericas( decodificaDad.getDichiaranteDecodifica(request.getFiltro() ));
	}
