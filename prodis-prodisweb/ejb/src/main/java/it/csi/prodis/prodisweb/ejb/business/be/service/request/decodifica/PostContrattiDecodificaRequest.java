 ...
 */
public class PostContrattiDecodificaRequest implements BaseRequest {

	
	private final DecodificaGenerica filtro;
	
	public PostContrattiDecodificaRequest(DecodificaGenerica filtro) {
		this.filtro = filtro;
	}
	...
	public String toString() {
		...
		builder.append("PostContrattiDecodificaRequest []");
