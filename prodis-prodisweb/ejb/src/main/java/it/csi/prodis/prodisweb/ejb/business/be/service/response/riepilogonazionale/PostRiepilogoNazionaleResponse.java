 ...
 */
public class PostRiepilogoNazionaleResponse extends BasePostResponse<Integer, RiepilogoNazionale> {
	...
	public String toString() {
		...
		builder.append("PostRiepilogoNazionaleResponse [riepilogoNazionale=").append(riepilogoNazionale).append(", apiErrors=")
