 ...
 */
public class PostCategoriaEscluseDecodificaRequest implements BaseRequest {

	
	private final DecodificaGenerica filtro;
	
	public PostCategoriaEscluseDecodificaRequest(DecodificaGenerica filtro) {
		this.filtro = filtro;
	}
	...
	public String toString() {
		...
		builder.append("PostCategoriaEscluseDecodificaRequest []");
