...
public class DeleteLavoratoriInForzaResponse extends BasePostResponse<Integer, LavoratoriInForza> {
	...
	public String toString() {
		...
		builder.append("DeleteLavoratoriInForzaResponse [lavoratoriInForza=").append(lavoratoriInForza).append(", apiErrors=")
