 ...
 */
public abstract class BaseCategorieEscluseService<Q extends BaseRequest, R extends BaseResponse> extends BaseService<Q, R> {

	/** Data Access Delegate for CategorieEscluse  */
	protected final CategorieEscluseDad categorieEscluseDad;
	/**
	 * Constructor
	 * 
	 ...
	 */
	protected BaseCategorieEscluseService(ConfigurationHelper configurationHelper,  CategorieEscluseDad categorieEscluseDad) {
