...
/**
 * Data Access Object interface for the entity ProTSoggetti
 */
public interface ProTSoggettiDao extends BaseEntityDao<Long, ProTSoggetti> {

	List<ProTSoggetti> findByField(String field);
	
	List<DecodificaGenerica> findByFilter(DecodificaGenerica filtro);
	
	ProTSoggetti findBycodSoggetti(String codSoggetti);
