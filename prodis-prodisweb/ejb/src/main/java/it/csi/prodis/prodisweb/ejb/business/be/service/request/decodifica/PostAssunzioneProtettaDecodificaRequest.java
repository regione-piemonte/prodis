 ...
 */
public class PostAssunzioneProtettaDecodificaRequest implements BaseRequest {

	
	private final DecodificaGenerica filtro;
	
	public PostAssunzioneProtettaDecodificaRequest(DecodificaGenerica filtro) {
		this.filtro = filtro;
	}
	...
	public String toString() {
		...
		builder.append("PostAssunzioneProtettaDecodificaRequest []");
