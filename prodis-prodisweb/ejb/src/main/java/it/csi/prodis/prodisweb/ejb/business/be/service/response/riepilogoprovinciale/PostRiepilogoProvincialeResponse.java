 ...
 */
public class PostRiepilogoProvincialeResponse extends BasePostResponse<Integer, RiepilogoProvinciale> {
	...
	public String toString() {
		...
		builder.append("PostRiepilogoProvincialeResponse [riepilogoProvinciale=").append(riepilogoProvinciale).append(", apiErrors=")
