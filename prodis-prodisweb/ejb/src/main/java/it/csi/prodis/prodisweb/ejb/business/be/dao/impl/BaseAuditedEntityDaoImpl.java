 ...
 * =========================LICENSE_END==================================
 */
package it.csi.prodis.prodisweb.ejb.business.be.dao.impl;
...
import it.csi.prodis.prodisweb.ejb.entity.base.OptlockEntity;
...
////			entity.setProdisTUtenteUltimaModifica(prodisTUtente);
...
//	}
	...
	public T insert(T entity) {
		...
		entity.setdInserim(now);
		entity.setdAggiorn(now);
		entity.setCodUserInserim(utente.getCodiceFiscale());
		entity.setCodUserAggiorn(utente.getCodiceFiscale());
