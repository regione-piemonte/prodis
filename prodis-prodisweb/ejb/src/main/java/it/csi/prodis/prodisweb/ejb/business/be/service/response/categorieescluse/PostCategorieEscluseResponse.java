 ...
 */
public class PostCategorieEscluseResponse extends BasePostResponse<Integer, CategorieEscluse> {
	...
	public String toString() {
		...
		builder.append("PostCategorieEscluseResponse [categorieEscluse=").append(categorieEscluse).append(", apiErrors=")
