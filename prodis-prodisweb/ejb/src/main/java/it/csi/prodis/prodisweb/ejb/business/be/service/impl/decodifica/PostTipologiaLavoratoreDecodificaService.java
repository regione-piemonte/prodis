 ...
 * Gets the Provincias
 */
public class PostTipologiaLavoratoreDecodificaService extends BaseDecodificaService<PostTipologiaLavoratoreDecodificaRequest, PostDecodificaGenericaResponse> {
	 ...
	 */
	public PostTipologiaLavoratoreDecodificaService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		response.setDecodificaGenericas(decodificaDad.getTipologiaLavoratoreDecodifica(request.getFiltro() ));
	}
