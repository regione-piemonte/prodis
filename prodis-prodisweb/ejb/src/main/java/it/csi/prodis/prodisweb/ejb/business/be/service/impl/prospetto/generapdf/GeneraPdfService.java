...
public class GeneraPdfService extends BaseService<GeneraPdfRequest, GeneraPdfResponse> {

	public GeneraPdfService(ConfigurationHelper configurationHelper) {
	...
	protected void execute() {
		...
		try {
			...
			response.setFileNameTemplate("Prospetto-" + idProspetto + ".pdf");
