...
public class PostIntermittentiResponse extends BasePostResponse<Integer, ProvIntermittenti> {
	...
	public String toString() {
		...
		builder.append("PostIntermittentiResponse [intermittenti=").append(intermittenti).append(", apiErrors=")
