...
/**
 * Data Access Object interface for the entity ProTCpi
 */
public interface ProTCpiDao extends BaseEntityDao<Long, ProTCpi> {

	List<ProTCpi> findByField(String field);
}
