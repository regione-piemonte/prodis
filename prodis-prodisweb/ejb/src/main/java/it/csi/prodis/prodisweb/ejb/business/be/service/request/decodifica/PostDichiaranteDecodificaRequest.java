 ...
 */
public class PostDichiaranteDecodificaRequest implements BaseRequest {

	
	private final DecodificaGenerica filtro;
	
	public PostDichiaranteDecodificaRequest(DecodificaGenerica filtro) {
		this.filtro = filtro;
	}
	...
	public String toString() {
		...
		builder.append("PostDichiaranteDecodificaRequest []");
