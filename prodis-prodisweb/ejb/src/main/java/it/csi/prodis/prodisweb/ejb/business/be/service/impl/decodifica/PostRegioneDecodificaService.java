 ...
 * Gets the Provincias
 */
public class PostRegioneDecodificaService
		extends BaseDecodificaService<PostRegioneDecodificaRequest, PostDecodificaGenericaResponse> {
	 ...
	 */
	public PostRegioneDecodificaService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		response.setDecodificaGenericas(decodificaDad.getRegioneDecodifica(request.getFiltro()));
	}
