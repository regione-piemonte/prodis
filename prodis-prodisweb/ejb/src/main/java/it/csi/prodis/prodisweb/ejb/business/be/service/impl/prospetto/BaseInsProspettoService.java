 ...
 */
public abstract class BaseInsProspettoService<Q extends BaseRequest, R extends BaseResponse> extends BaseService<Q, R> {
	 ...
	 */
	protected BaseInsProspettoService(ConfigurationHelper configurationHelper, 
			ProspettoDad prospettoDad, DatiProvincialiDad datiProvincialiDad) {
