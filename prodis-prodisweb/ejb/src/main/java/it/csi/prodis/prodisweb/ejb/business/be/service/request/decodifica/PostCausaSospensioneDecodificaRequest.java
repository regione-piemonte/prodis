 ...
 */
public class PostCausaSospensioneDecodificaRequest implements BaseRequest {

	
	private final DecodificaGenerica filtro;
	
	public PostCausaSospensioneDecodificaRequest(DecodificaGenerica filtro) {
		this.filtro = filtro;
	}
	...
	public String toString() {
		...
		builder.append("PostCausaSospensioneDecodificaRequest []");
