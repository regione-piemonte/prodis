...
//	Caused by: org.hibernate.MappingException: Repeated column in mapping for entity: it.csi.prodis.prodisweb.ejb.entity.ProDLavoratoriSilp column: ID_T_PROVINCIA (should be mapped with insert="false" update="false")
//	@ManyToOne
