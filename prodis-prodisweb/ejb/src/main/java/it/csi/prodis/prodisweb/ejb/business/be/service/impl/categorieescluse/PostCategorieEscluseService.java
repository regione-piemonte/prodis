...
public class PostCategorieEscluseService extends BaseCategorieEscluseService<PostCategorieEscluseRequest, PostCategorieEscluseResponse> {
	/**
	 * Constructor
	 * 
	 ...
	 */
	public PostCategorieEscluseService(ConfigurationHelper configurationHelper, CategorieEscluseDad categorieEscluseDad) {
	...
	protected void execute() {
		...
		if (apiErrors == null || apiErrors.size() == 0) {
			if (categorieEscluse.getId()==null) {
				categorieEscluse = categorieEscluseDad.insertSingleCategorieEscluse(categorieEscluse, categorieEscluse.getIdProspettoProv().intValue());
			} else {
