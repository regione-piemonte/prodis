...
/**
 * Base service implementation for the riepilogoNazionale
 * 
 * @param <Q> the request type
 * @param <R> the response type
 */
public abstract class BaseRiepilogoNazionaleService<Q extends BaseRequest, R extends BaseResponse> extends BaseService<Q, R> {
	 ...
	 */
	protected BaseRiepilogoNazionaleService(ConfigurationHelper configurationHelper,  RiepilogoNazionaleDad riepilogoNazionaleDad) {
