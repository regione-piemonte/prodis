...
public class UploadProspettoLavoratoriInForzaService 
extends BaseUploadDownloadLavoratoriInForzaService<UploadLavoratoriInForzaRequest, UploadLavoratoriInForzaResponse> {

	public UploadProspettoLavoratoriInForzaService(ConfigurationHelper configurationHelper, LavoratoriInForzaDad lavoratoriInForzaDad) {
	...
	protected void execute() {
        ...
        MassivoLavoratoriEsito esito = null;
        
        esito = manager.uploadProspettoLavoratori(prospetto, fileInByte, prospetto.getCodUserAggiorn());
		...
		response.setFileNameTemplate("Esiti-" + idProspetto);
