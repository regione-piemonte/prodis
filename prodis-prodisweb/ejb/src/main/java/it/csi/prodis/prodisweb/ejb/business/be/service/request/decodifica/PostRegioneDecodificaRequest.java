 ...
 */
public class PostRegioneDecodificaRequest implements BaseRequest {

	private final DecodificaGenerica filtro;

	public PostRegioneDecodificaRequest(DecodificaGenerica filtro) {
		this.filtro = filtro;
	}
	...
	public String toString() {
		...
		builder.append("PostRegioneDecodificaRequest []");
