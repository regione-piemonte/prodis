...
/**
 * Data Access Object interface for the entity ProTCcnl
 */
public interface ProTCcnlDao extends BaseEntityDao<Long, ProTCcnl> {

	List<ProTCcnl> findByField(Long field);
