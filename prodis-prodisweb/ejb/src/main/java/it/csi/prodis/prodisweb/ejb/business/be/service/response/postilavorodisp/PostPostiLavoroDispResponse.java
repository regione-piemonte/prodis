...
/**
 * The Class PostPostiLavoroDispResponse.
 */
public class PostPostiLavoroDispResponse extends BasePostResponse<Integer, PostiLavoroDisp> {
	...
	public String toString() {
		...
		builder.append("PostPostiLavoroDispResponse [compensazioni=").append(postiLavoroDisp).append(", apiErrors=")
