 ...
 */
public class PostStatoConcessioneDecodificaRequest implements BaseRequest {

	
	private final DecodificaGenerica filtro;
	
	public PostStatoConcessioneDecodificaRequest(DecodificaGenerica filtro) {
		this.filtro = filtro;
	}
	...
	public String toString() {
		...
		builder.append("PostStatoConcessioneDecodificaRequest []");
