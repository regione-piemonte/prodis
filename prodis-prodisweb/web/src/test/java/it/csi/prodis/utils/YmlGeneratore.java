...
import it.csi.prodis.prodisweb.lib.dto.prospetto.ImportErrori;
...
import it.csi.prodis.prodisweb.lib.dto.prospetto.PdfSilp;
...
import it.csi.prodis.prodisweb.lib.dto.prospetto.ProspettoProvSede;
...
public class YmlGeneratore {
	...
	// "D:\\workspace-prodis\\prodisweb\\docs\\definitions";
	...
	public static void main(String[] args) {
		try {
			...
			go(RicercaProspetto.class, PATH_PROSPETTO);
			...
			go(ConfermaRiepilogo.class, PATH_PROSPETTO);
	...
	private static void go(Class objClass, String path, Class pkClass) throws FileNotFoundException, IOException {
		...
		for (Method method : methods) {
			...
			if (method.getName().startsWith("get")) {
				...
				} else if (method.getReturnType().getCanonicalName().startsWith("it.csi.prodis.prodisweb.lib.dto.")) {
