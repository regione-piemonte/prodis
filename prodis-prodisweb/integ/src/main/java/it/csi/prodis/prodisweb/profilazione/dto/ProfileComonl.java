...
public class ProfileComonl implements Serializable {
  ...
  private DatiAggiuntiviConsulente consulente;
  ...
  private List<DatiAggiuntiviImpresa> datiAggiuntiviImpresa;
  ...
  public DatiAggiuntiviConsulente getConsulente() {
    return consulente;
  }

  public void setConsulente(DatiAggiuntiviConsulente consulente) {
  ...
  public List<DatiAggiuntiviImpresa> getDatiAggiuntiviImpresa() {
    return datiAggiuntiviImpresa;
  }

  public void setDatiAggiuntiviImpresa(List<DatiAggiuntiviImpresa> datiAggiuntiviImpresa) {
    this.datiAggiuntiviImpresa = datiAggiuntiviImpresa;
  }
  ...
  public String toString() {
    return "ProfiloComonl [capDomicilio=" + capDomicilio + ", capResidenza=" + capResidenza + ", codiceCittadinanza=" + codiceCittadinanza + ", codiceComuneDomicilio=" + codiceComuneDomicilio + ", codiceComuneNascita=" + codiceComuneNascita + ", codiceComuneResidenza=" + codiceComuneResidenza
        + ", codiceEnte=" + codiceEnte + ", codiceFiscaleInput=" + codiceFiscaleInput + ", codiceStatoEsteroDomicilio=" + codiceStatoEsteroDomicilio + ", codiceStatoEsteroNascita=" + codiceStatoEsteroNascita + ", codiceStatoEsteroResidenza=" + codiceStatoEsteroResidenza + ", cognome=" + cognome
        + ", comuneDomicilio=" + comuneDomicilio + ", consulente=" + consulente + ", dataFineCarica=" + dataFineCarica + ", dataInsert=" + dataInsert + ", dataNascita=" + dataNascita + ", dataUltimaModifica=" + dataUltimaModifica + ", datiAggiuntiviImpresa=" + datiAggiuntiviImpresa
        + ", delegaValida=" + delegaValida + ", descrizioneCittadinanza=" + descrizioneCittadinanza + ", descrizioneComuneDomicilio=" + descrizioneComuneDomicilio + ", descrizioneComuneNascita=" + descrizioneComuneNascita + ", descrizioneComuneResidenza=" + descrizioneComuneResidenza
        + ", descrizioneStatoEsteroDomicilio=" + descrizioneStatoEsteroDomicilio + ", descrizioneStatoEsteroNascita=" + descrizioneStatoEsteroNascita + ", descrizioneStatoEsteroResidenza=" + descrizioneStatoEsteroResidenza + ", email=" + email + ", fax=" + fax + ", genere=" + genere
        + ", gruppoOperatori=" + gruppoOperatori + ", idComDSoggettoAbilitato=" + idComDSoggettoAbilitato + ", idUserInsert=" + idUserInsert + ", idUserUltimaModifica=" + idUserUltimaModifica + ", indirizzoDomicilio=" + indirizzoDomicilio + ", indirizzoResidenza=" + indirizzoResidenza + ", nome="
        + nome + ", telefono=" + telefono + ", tipoAnagrafica=" + tipoAnagrafica + "]";
  }
